...
CREATE TABLE  student_baseinfo (
  ...
  xy VARCHAR(1) CHARACTER SET GBK DEFAULT NULL COMMENT '协议',
  bz VARCHAR(2000) CHARACTER SET GBK DEFAULT NULL COMMENT '招生备注',
  ...
  jfrq2 VARCHAR(19) CHARACTER SET GBK DEFAULT NULL COMMENT '缴费日期2',
  jfje2 DOUBLE(8,2) DEFAULT 0 COMMENT '缴费金额2',
  jfskr2 INT DEFAULT NULL COMMENT '缴费收款人2',
